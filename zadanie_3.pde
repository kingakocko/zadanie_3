def setup():
    ...
    noFill()
    stroke("#79BFA1")
    triangle(positionOfFirstLetter[0]-50, positionOfFirstLetter[1]+s, positionOfFirstLetter[0]+200, positionOfSecondLetter[1]+s, (positionOfFirstLetter[0]+positionOfFirstLetter[0]+150)/2, positionOfFirstLetter[1]-100)
